...
The interactive subcommand lets you navigate the source objects and their migration status, then migrate selected objects individually.

![Rancher Access Migrator interactive example](assets/interactive-demo.gif)
